...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-2">
        ...
        <flux:heading size="xl" level="1">Add New Employee</flux:heading>
    </div>
        ...
        <form action="{{ route('employees.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <flux:field>
                    ...
                    <flux:select name="department_id" placeholder="Select department..." required>
                ...
                <flux:field>
                    <flux:label>Monthly Salary</flux:label>
